const translations = {
  en: {
    ...
    metaDescription: "Profile of Seonhyo Choi, a software engineer working with Flutter, computer vision, and on-device AI.",
    heroTitle: "An engineer working across technology and business.",
    heroLead:
      "I am most motivated when building things that deliver clear value to people.",
    heroDescription: [
      "Currently building Flutter applications powered by computer vision in the healthcare domain, with product know-how that transfers across stacks.",
      "Actively working with AI agents, and exploring how to clear the bottlenecks that surface as productivity scales.",
    ],
    heroHighlights: [],
    ...
    profileRole: "Software Engineer | Flutter, Computer Vision, On-device AI",
    aboutDescription: "",
    aboutItems: [
      ["Strengths", "Flutter, optical device integration, image processing, AI pipeline design, framework internals"],
      ["Work Style", "Ownership, culture contribution, data- and visualization-based discussion, modularizing repetitive work, digging into source code"],
    ],
